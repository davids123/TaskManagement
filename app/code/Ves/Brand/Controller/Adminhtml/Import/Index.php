...
class Index extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Ves_Brand::import_products');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Ves_Brand::brand')
            ...
            ->addBreadcrumb(__('Import Products for Tasks'), __('Import Products for Tasks'));
        return $resultPage;
    }
    ...
    public function execute(){
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Import Products for Tasks'));
        return $resultPage;
    }
}